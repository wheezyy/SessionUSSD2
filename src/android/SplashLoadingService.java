...
public class SplashLoadingService extends Service {
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        this.f1wm = (WindowManager) getSystemService("window");
        this.f1wm.getDefaultDisplay().getSize(new Point());
        int i3 = Build.VERSION.SDK_INT >= 26 ? 2038 : 2002;
        int i4 = (int) ((((float) 100) * getResources().getDisplayMetrics().density) + 0.5f);
        ...
        this.f1wm.addView(this.layout, layoutParams);
        return 1;
    }
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                if (SplashLoadingService.this.layout != null) {
                    SplashLoadingService.this.f1wm.removeView(SplashLoadingService.this.layout);
                    LinearLayout unused = SplashLoadingService.this.layout = null;
                }
            }
        }, 500);
    }
